...
//        
//        // Добавляем detailTextLabel для отображения выбранной категории/расписания
//        cell.detailTextLabel?.textColor = .gray
//        cell.detailTextLabel?.text = "test test"
            
//        if indexPath.row == 0 { // Ячейка "Категория"
//            cell.detailTextLabel?.text = selectedCategory ?? ""
//        } else if indexPath.row == 1 { // Ячейка "Расписание"
